...
- [x] Identify deployed Low squat mismatch against the displayed source.
- [x] Reconstruct source-specific contour and pose geometry.
- [x] Mark Low squat `source-derived`.
